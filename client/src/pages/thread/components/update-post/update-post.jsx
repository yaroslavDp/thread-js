...
import { useAppForm, useCallback, useDispatch, useState } from '~/libs/hooks/hooks.js';
...
const UpdatePost = ({ post, onUploadImage, onUpdatePostToggle }) => {
  ...
  const handlePostUpdate = useCallback(postPayload => dispatch(threadActionCreator.updatePost(postPayload)),[dispatch]);
  const handleUpdatePostClose = useCallback(() => onUpdatePostToggle(),[onUpdatePostToggle]);
